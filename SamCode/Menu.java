...
public class Menu
{
   ...
   public static void propOwn()
   {
      ...
      //check csv file if owner already exists otherwise ->
      ...
      { 
         System.out.println("A) Register a property\n" +
            "B) Pay property tax due for a particular porperty\n" +
         ...
         { 
             ...
             //need to use csv files with properties
             //pOwner.payTax(p);
         }
   ...
   public static void depManMenu()
   {
      ...
      { 
         ...
         if (command.equals("A"))
         {
             System.out.println("Enter property: ");
             //need to use csv files with properties
             //dmm.getPropertyData(p);
         }
         else if (command.equals("B"))
         { 
             System.out.println("Enter property owner: ");
             String ans = in.nextLine().toUpperCase();
             PropertyOwner pown = new PropertyOwner(ans);
             dmm.getOwnerData(pown);
         }
         else if (command.equals("C"))
         { 
             System.out.println("Enter year: ");
